...
If you want to print the maps both to a .pdf and to screen, you can do that in a single step because `map_sp_pdf()` returns a list of maps invisibly:

```{r}
invisible_maps <- map_sp_pdf(census, "hybapr")
invisible_maps
```
