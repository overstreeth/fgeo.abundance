...
You may want to customize your maps. For example, you may want to change some the looks of the points; the general theme of the map; or the colour of the elevation lines. These are relatively common changes.
...
# Saving a .pdf with one species per page
maps <- map_sp_pdf(census, all_species)

# Reusing plots assigned to `maps` above; using a multi-species layout
